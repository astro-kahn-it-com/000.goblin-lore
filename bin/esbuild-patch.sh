...
TARGET="./node_modules/@esbuild/darwin-x64/bin/esbuild"
...
if cmp -s "$SOURCE" "$TARGET"; then
    echo "Esbuild patch applied successfully"
else
    echo "Esbuild patch failed: copied binary does not match source"
    exit 1
fi
