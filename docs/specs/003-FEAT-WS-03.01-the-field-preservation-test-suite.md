# 📋 FEATURE: 03.01 — THE FIELD-PRESERVATION TEST SUITE

**Feature ID:** `FEAT-WS-03.01` **Parent Epic:** [EPIC-003] THE ROUND-TRIP GUARANTEE **Governing
...
**Strategic Goal** Implements the capabilities of THE FIELD-PRESERVATION TEST SUITE to secure the
...
| ------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------------------------- |
| the-field-preservation-test-suite.ts | `worker-sower/scripts/the-field-preservation-test-suite.ts` | `npx ts-node worker-sower/scripts/the-field-preservation-test-suite.ts` exits 0 |
...
- **Blocking Downstream:**
  - `FEAT-03.02`: Unknown — blocked until current is resolved.
- **Waiting On:**
  - None
